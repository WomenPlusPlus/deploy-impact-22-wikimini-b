...
export interface MwnStreamStatic {
    ...
    recentchange(filter: Partial<RecentChangeStreamEvent> | ((data: RecentChangeStreamEvent) => boolean), action: (data: RecentChangeStreamEvent) => void): MwnStream;
}
 ...
 */
export declare type RecentChangeStreamEvent = {
    $schema: string;
    meta: {
        uri: string;
        request_id: string;
 ...
 */
export declare type recentchangeProps = RecentChangeStreamEvent;
